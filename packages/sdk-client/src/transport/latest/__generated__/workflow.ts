...
export type TestWorkflowConvertMutationVariables = Types.Exact<{
  input: Types.TestWorkflowConvertInput;
}>;
...
export type ToggleWorkflowMutationVariables = Types.Exact<{
  id: Types.Scalars["ID"]["input"];
...
export type RunConvertWorkflowMutationVariables = Types.Exact<{
  id: Types.Scalars["ID"]["input"];
  input: Types.Scalars["Blob"]["input"];
}>;
...
export type RunActiveWorkflowMutationVariables = Types.Exact<{
  id: Types.Scalars["ID"]["input"];
  input: Types.RunActiveWorkflowInput;
}>;
...
>;
export const TestWorkflowConvertDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "TestWorkflowConvert" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "TestWorkflowConvertInput" },
            },
          },
        },
      ],
...
export const ToggleWorkflowDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "ToggleWorkflow" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
  ...
  ToggleWorkflowMutationVariables
>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "RunConvertWorkflow" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
        ...
        },
        {
          ...
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "Blob" } },
          },
        },
      ],
      selectionSet: {
...
>;
export const RunActiveWorkflowDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "RunActiveWorkflow" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
        ...
        },
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "RunActiveWorkflowInput" },
            },
          },
        },
      ],
  ...
  RunActiveWorkflowMutation,
  RunActiveWorkflowMutationVariables
>;
